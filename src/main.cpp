...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
	...
	if (!fTestNet && pindexLast->nTime > 1510113600)	// Nov 08 2017, 04:00 GMT
...
bool LoadBlockIndex()
{
	if (fTestNet)
	{
		...
		hashGenesisBlock = uint256("0x83b9153a393cb8b9c4857932f37b2c3fb8ce65077029b8f7e3b2db11a7fae0d1");
	}
